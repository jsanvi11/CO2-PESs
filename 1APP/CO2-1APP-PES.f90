...
!
    ...
    ener(1)=ener(1)!-0.005513108815325485d0
    ...
    ener(2)=ener(2)+0.0781653493195692d0
    ...
    ener(3)=ener(3)+0.0781653493195692d0
...
real*8, parameter :: wtol = epsilon(1.0d0), dr1 = 0.90d0, dr2 = 1.00d0, dr3 =1.00d0
...
subroutine co21apppes(tmpr, totener, dvdr)
implicit none

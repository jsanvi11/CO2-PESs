...
!
    ...
    ener(1)=ener(1)!+0.00615396834297715d0
...
real*8, parameter :: wtol = epsilon(1.0d0), dr1 = 0.85d0, dr2 = 1.25d0, dr3 =1.25d0
...
subroutine co23appes(tmpr, totener, dvdr)
implicit none
